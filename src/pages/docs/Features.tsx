...
export default function Features() {
  return (
    <div className="pb-10">
      ...
      <div id="physical-verification" className="scroll-mt-24 py-8">
      ...
      <div id="guarantor-verification" className="scroll-mt-24 py-8">
      ...
      <div id="professional-verification" className="scroll-mt-24 py-8">
      ...
      <div id="academic-health-verification" className="scroll-mt-24 py-8">
